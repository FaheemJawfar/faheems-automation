      ...
      <div className="projects">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="image-preview">
              <img src={automationProject1} alt="Test Automation Framework" />
            </div>
            <div className="body">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="image-preview">
              <img src={automationProject3} alt="RPA Framework" />
            </div>
            <div className="body">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="image-preview">
              <img src={automationProject1} alt="Test Data Generator" />
            </div>
            <div className="body">
